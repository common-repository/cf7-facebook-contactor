...
class CF7FB_Contactor_Utility {
    ...
    /**
    * Get the singleton instance of the CF7FB_Contactor_Utility class
    *
    * @return singleton instance of CF7FB_Contactor_Utility
    */
   public static function instance() {

      static $instance = NULL;
      if ( is_null( $instance ) ) {
         $instance = new CF7FB_Contactor_Utility();
      }
      return $instance;
   }
    ...
    */
    public static function gs_debug_log($error){
		try{	
			if( ! is_dir( CF7FB_CONTACTOR_PATH.'logs' ) ){
				mkdir( CF7FB_CONTACTOR_PATH . 'logs', 0755, true );
			}
		} catch (Exception $e) {

		}
		try{
			$log = fopen( CF7FB_CONTACTOR_PATH . "logs/log.txt", 'a');
			if ( is_array( $error ) ) {
